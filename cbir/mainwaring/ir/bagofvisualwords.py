...
class BagOfVisualWords:
    def __init__(self, codebook, sparse=True):
        # Store codebook used to compute bag-of-visual-words representation for each image
        # along with the flag used to control whether sparse or dense histograms are constructed
        self.codebook = codebook
        self.sparse = sparse

    def describe(self, features):
        # compute Euclidean distance between the features and the cluster centres,
